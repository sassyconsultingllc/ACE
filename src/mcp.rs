...
impl AgentConfig {
    pub fn grok_default() -> Self {
        AgentConfig {
            ...
            api_key: Some("xai-lONBXXMUdXD08kslDvH7VqJOtqOZJv1OXaNMe5Z5FxrFZDHsUDDkHI58KKiUmP77Shxk5fpeFqtR2vhP".to_string()),
    ...
    pub fn claude_default() -> Self {
        AgentConfig {
            ...
            api_key: Some("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".to_string()),
    ...
    pub fn gemini_default() -> Self {
        AgentConfig {
            ...
            api_key: Some("AIzaSyC4h4x6koUvbCg_qH52x9hUsXIv2sGkM2Q".to_string()),
