...
pub enum FamilyNotification {
    ...
    DeviceRequest { device: FamilyDevice },
    /// Device was approved
    DeviceApproved {
        device_id: String,
        device_name: String,
...
mod tests {
    ...
    fn test_family_flow() {
        ...
        // Parent approves
        config
            .approve_device("kid-phone", "parent-phone", TrustLevel::Trusted)
            .unwrap();
    ...
    fn test_trust_upgrade() {
        ...
        config
            .approve_device("kid", "parent", TrustLevel::Supervised)
            .unwrap();

        // Kid turns 13, upgrade to trusted
        config
            .upgrade_trust("kid", "parent", TrustLevel::Trusted)
            .unwrap();
