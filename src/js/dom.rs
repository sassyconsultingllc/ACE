...
use super::value::{DomElement, Value};
...
impl DomBridge {
    ...
    pub fn create_window_object(&self) -> Value {
        ...
        location
            .borrow_mut()
            .insert("href".to_string(), Value::String("about:blank".to_string()));
        location
            .borrow_mut()
            .insert("protocol".to_string(), Value::String("about:".to_string()));
        location
            .borrow_mut()
            .insert("host".to_string(), Value::String("".to_string()));
        location
            .borrow_mut()
            .insert("pathname".to_string(), Value::String("blank".to_string()));
        win.borrow_mut()
            .insert("location".to_string(), Value::Object(location));

        // window.innerWidth, window.innerHeight
        win.borrow_mut()
            .insert("innerWidth".to_string(), Value::Number(1920.0));
        win.borrow_mut()
            .insert("innerHeight".to_string(), Value::Number(1080.0));

        // window.navigator
        let navigator = Rc::new(RefCell::new(HashMap::new()));
        navigator.borrow_mut().insert(
            "userAgent".to_string(),
        ...
        win.borrow_mut()
            .insert("navigator".to_string(), Value::Object(navigator));
